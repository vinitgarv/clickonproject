...
@Component({
  selector: 'app-sidebarlogout',
  imports: [],
  template: `
     <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.5938 6.71875L16.875 10L13.5938 13.2812" stroke="#5F6C72" stroke-width="1.5" stroke-linecap="round"
...
export class SidebarLogoutComponent {
